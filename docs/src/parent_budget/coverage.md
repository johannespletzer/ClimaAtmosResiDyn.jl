...
| `impl.solve_defect`             | Newton stage residual                                        | implicit configurations                                                    | `T_imp!` | atmosphere | `ρ`, `ρq_tot`, `ρe_tot`                  | measured · measured · measured | leading order at `max_iters = 1`; sign and accepted weight verified                                                                                                   | decomposition | collected | independent projection of the algebraic residual                     | `implicit_attribution_tests.jl` | 5    |
