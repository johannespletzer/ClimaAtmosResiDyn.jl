...
include("stratospheric_tracer_diagnostics.jl")
include("tagged_tracer_diagnostics.jl")
include("tagged_water_diagnostics.jl")
include("energy_source_tag_diagnostics.jl")
include("tag_ledger_diagnostics.jl")
include("process_record_diagnostics.jl")
