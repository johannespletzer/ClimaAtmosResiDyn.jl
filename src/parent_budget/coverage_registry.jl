...
const COVERAGE_ROWS = CoverageRow[
    ...
    CoverageRow(
        ...
        "`Yₜ`",
        "`diff_mode` and advection config",
        "atmosphere",
        "`ρ`, `ρe_tot`, tracers, `u₃`",
        (:invariant_zero, :invariant_zero, :invariant_zero),
    ...
    CoverageRow(
        ...
        "`dss!`",
        "`dss!`",
        "distributed or spectral element",
        "atmosphere",
        "`ρ`, `ρq_tot`, `ρe_tot`",
        (:measured, :measured, :measured),
    ...
    CoverageRow(
        ...
        :final_map,
        :collected,
        "endpoint pair across the restart boundary, compared exactly before the first transaction opens",
