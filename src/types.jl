...
"""
    AtmosModel{W, SCM, R, TC, PF, GW, VD, SP, SU, NU, CM, TG, COSP, G, P, SE}
...
below.
"""
struct AtmosModel{W, SCM, R, TC, PF, GW, VD, SP, SU, NU, CM, TG, COSP, G, P, SE}
    water::W
    scm_setup::SCM
    radiation::R
    turbconv::TC
...
function _atmos_model(; kwargs...)
    ...
    return AtmosModel(
        ...
        vertical_diffusion, sponge, surface, numerics, chemistry, tagging, cosp,
