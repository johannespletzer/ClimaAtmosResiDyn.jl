...
# Phase A, the water runs -- the tcsh variant of phase_a.sh.
#
...
# written in, so phase_a.sh works perfectly well when submitted from tcsh --
...
#     sbatch experiments/tag_closure/runscripts/phase_a.tcsh
#
# Submit from the repository root. The #SBATCH block matches phase_a.sh
