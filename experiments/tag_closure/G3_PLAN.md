...
| V-W8  | A file-based column with water and energy tags: `prognostic_edmfx_tv_era5driven_column` (0M) for 3 h, if its forcing is on disk. A download needs the owner's approval                                                   | 1        | WP3        |
...
## 8. Risks and open questions
  ...
  - **V-W8 depends on ERA5 forcing on disk.** A download needs the owner.
