...
Each was checked against the code on this branch.
 ...
 3. *In #74, `fbeb561e`.* **`tracer_configuration.md:410-414`** says the energy tags "never receive
 ...
 5. *In #72, `f3f48e97`.* **`energy_source_tags.md:292-294`**, under the audit: "the SGS closures"
 ...
 7. *In #74 (sedimentation) and #72 (the audit).* **`energy_source_tags.md:211-227`**, the tested boundary. The integration
 ...
 8. *Done in #70, `4c274aed`.* **`process_record.md:120-125`** says `microphysics` is recorded however
    ...
    never writes `ρe_tot`.
 9. *In #74, `fbeb561e`.* **`process_record.md:137-140`** says the records do not add up to the
    change in the parent. At a point, yes. Over a column they do, to 3.3e-7 J/m²
    under 0M (E26). Say both.
10. *In #74, `fbeb561e`: a section in `energy_source_tags.md`.* **Neither page defines form A and form B**, or the validating layout. Link
