...
W=/dss/dsstbyfs02/scratch/0D/di38kez/claude_work/g3/wp5b
if [ "$LABEL" = off ]; then ENV=$W/testenv-off; CODE=/dss/dsshome1/0D/di38kez/git/Clima/ClimaAtmosResiDyn-wedmf5b-off; else ENV=$W/testenv; CODE=/dss/dsshome1/0D/di38kez/git/Clima/ClimaAtmosResiDyn-wedmf5b; fi
