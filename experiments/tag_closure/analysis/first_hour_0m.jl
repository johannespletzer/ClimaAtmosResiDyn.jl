...
# Point 1: what makes the audit's first-hour residual on the C9 column.
# Steps configs/c9_column_enthalpy.yml per step for 2 h in several variants and
...
const BASE = "experiments/tag_closure/configs/c9_column_enthalpy.yml"
...
const VARIANTS = [
    ...
    ("newton", NEWTON),
    ("central", CENTRAL),
    ("central_newton", merge(NEWTON, CENTRAL)),
    ("dt5", Dict{String, Any}("dt" => "5secs")),
]
