...
| OD14 | Held-out hygiene: one held-out case, its window and its metrics, named before any rule is tuned on PX11's result, with a reference valid there; whether criterion 8's GCM-driven column, which starts from site 23, still counts as held out; Soares, TRMM 0M and sites 23 and 26 are development cases; a held-out case never develops a rule                                                                                                                                                                                                                                                                                                                                          | PX23; step 8b                                        | PROVENANCE_PATHWAY.md, section 9                                                                                                                                                                                                                                                                                                                                                                                                     | **PROPOSED** 2026-09-26 (provenance pathway), not yet accepted; OWNER DECISION REQUIRED (OD14) once accepted                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
not rewritten. The row comes from G1's criterion 4b. G3_PLAN 6.1 argues against
...
convention effect, and that argument as written does not hold. The row stands
as approved, and so does
...
threshold. The rounding and floor rows are proposals under OD10 and OD12. They
apply only once the owner accepts those decisions. None of these numbers
